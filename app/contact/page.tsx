  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      value: "taylor@avarismarketing.com",
              ...
              <div className="bg-white p-10 rounded-2xl border border-light shadow-2xl relative overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                  ...
                  <motion.button
                    ...
                    className="w-full bg-forest text-fence py-4 rounded-lg font-semibold hover:bg-forest/90 transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                    disabled={isSubmitting}
                  >
